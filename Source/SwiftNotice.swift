...
extension UIResponder {
    ...
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Int = 1) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Int = 1) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Int = 1) -> UIWindow{
    ...
    func successNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 1)
    }
    @discardableResult
    func errorNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 1)
    }
    @discardableResult
    func infoNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: 1)
    }
    @discardableResult
    func notice(_ text: String, type: NoticeType, autoClear: Bool, autoClearTime: Int = 1) -> UIWindow{
